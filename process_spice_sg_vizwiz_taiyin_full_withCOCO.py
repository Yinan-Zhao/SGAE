...
spice_sg_folder = root_path + 'data/vizwiz_taiyin_full_withCOCO_spice_sg2/'
spice_sg_dict_raw_path = root_path + 'data/vizwiz_taiyin_full_withCOCO_spice_sg_dict_raw2.npz'
spice_sg_dict_path = root_path + 'data/vizwiz_taiyin_full_withCOCO_spice_sg_dict2.npz'

if not os.path.isdir(spice_sg_folder):
	os.mkdir(spice_sg_folder)

dict_info = json.load(open(root_path+'data/vizwiztalk_taiyin_full_withCOCO.json'))
